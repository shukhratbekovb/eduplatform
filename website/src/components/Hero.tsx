      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 rounded-full glass-light text-xs sm:text-sm text-accent mb-6 sm:mb-8"
          >
          ...
          >
            <a
              href="#apply"
              className="group inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl bg-accent text-dark-900 font-semibold text-base sm:text-lg hover:bg-accent-light transition-all hover:shadow-xl hover:shadow-accent/20 hover:-translate-y-0.5"
            >
              {t.hero.ctaPrimary}
            ...
            <a
              href="#courses"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl glass text-white font-medium text-base sm:text-lg hover:bg-white/10 transition-all"
            >
              {t.hero.ctaSecondary}
            </a>
          </motion.div>
          ...
          <motion.div
            ...
            className="grid grid-cols-3 gap-3 sm:gap-8 max-w-lg mx-auto"
          >
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-accent/10 text-accent mb-2">
